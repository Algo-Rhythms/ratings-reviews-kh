...
const createReview = () => {
  ...
  const product_id = faker.random.number(200);
...
const createPhoto = () => {
  // const id = faker.random.number(200);
  const reviewId = faker.random.number(10000);
...
const createCharsReviews = () => {
  // const id = faker.random.number(200);
  const product_id = faker.random.number(200);
  const review_id = faker.random.number(200);
  const value = faker.random.number(5);
  return `${product_id}, ${review_id}, ${value}\n`;
};
